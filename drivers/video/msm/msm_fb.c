					...
					enum led_brightness value)
{
	...
	//printk(KERN_ERR "[SKY_LCD_BL_CHECK] +%s, %d\n", __FUNCTION__, __LINE__);
			    ...
			    boolean op_enable)
{
	...
	//printk(KERN_ERR "msm_fb_blank_sub: op_enable : %d\n",op_enable);
	if (!op_enable)
		return -EPERM;
...
static int msm_fb_register(struct msm_fb_data_type *mfd)
{
...
#elif defined(CONFIG_MACH_APQ8064_EF51S) || defined(CONFIG_MACH_APQ8064_EF51K) || defined(CONFIG_MACH_APQ8064_EF51L) //|| defined(CONFIG_MACH_APQ8064_EF52S) || defined(CONFIG_MACH_APQ8064_EF52K) || defined(CONFIG_MACH_APQ8064_EF52L) //p14682 kobj 120829 modify active-area EF51S/K/L(129.6*72.9)
	...
	if (hdmi_prim_display ||
	    (mfd->panel_info.type != DTV_PANEL 
#if !defined (PANTECH_LCD_FIX_ABOUT_HALT_WHEN_LCD_ONOFF_DURING_WFD)
		 &&
