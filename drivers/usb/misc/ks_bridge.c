...
#if 0 //p10919 1220 mdm remotefs hello failed patch : CRs-Fixed: 403250, Fix bug in partial read on data buffer, Change-Id: I48217aeeb2ee5ad05089922c6a7793195b95ce0c
...
#if 1 //p10919 1220 mdm remotefs hello failed patch : CRs-Fixed: 403250, Fix bug in partial read on data buffer, Change-Id: I48217aeeb2ee5ad05089922c6a7793195b95ce0c
		pkt->n_read += len;
#endif
		space -= len;
		copied += len;
