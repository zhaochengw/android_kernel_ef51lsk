...
static struct acpu_level tbl_slow_1p7_offline[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   975000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   975000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
...
static struct acpu_level tbl_slow_2p0_offline[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   975000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   975000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
...
static struct pvs_table pvs_tables_offline[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[1][0] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][1] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][2] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][3] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][4] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][5] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },
	[1][6] = { tbl_slow_1p7_offline, sizeof(tbl_slow_1p7_offline),     0 },

	[2][0] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][1] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][2] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][3] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][4] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][5] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
	[2][6] = { tbl_slow_2p0_offline, sizeof(tbl_slow_2p0_offline),     0 },
};
#endif
