...
#define TZBSP_IMEM_CTX_BUFFER_ADDR  0x2a03f800
#define TZBSP_WDT_MAGIC_ADDR        0x2A03F66C
tzbsp_dump_buf_t* g_tzbsp_ctx_buf_ns;
void* g_tzbsp_ctx_buf_ns_addr;
#endif
...
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING
	g_tzbsp_ctx_buf_ns_addr = (void*)ioremap_nocache(TZBSP_IMEM_CTX_BUFFER_ADDR, SZ_4K);
	g_tzbsp_ctx_buf_ns = (tzbsp_dump_buf_t*)g_tzbsp_ctx_buf_ns_addr;
	wdt_magic_addr = (void*)ioremap_nocache(TZBSP_WDT_MAGIC_ADDR, SZ_4K);
